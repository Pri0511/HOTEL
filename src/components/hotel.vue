            ...
            <div class="parte1_2">
                <div class="imagen1">
                    <div class="sobre">
                        ...
                        <h2>has double-glazed windows for a quiet</h2>
                        <h2>and relaxing atmosphere. They have a</h2>
                        <h2>140 cm wide bed, bathroom with</h2>
                        <h2>bathtub and private toilet.</h2>
